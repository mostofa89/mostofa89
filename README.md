<!-- Header Section -->
<h1 align="center">👋 Hi, I'm <span style="color:#00bfff;">Abu Hena Mostofa Kamal Joy</span></h1>
...
<hr style="height:2px;border:none;background:linear-gradient(to right,#ff6a00,#ee0979,#007bff);" />
...
<hr style="height:2px;border:none;background:linear-gradient(to right,#007bff,#00ff99,#ffcc00);" />
